# Generated by Django 2.2.7 on 2019-11-24 06:50
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('display_type', models.PositiveIntegerField(choices=[(1, '显示'), (0, '隐藏')], default=1, verbose_name='展示类型')),
                ('content', models.TextField(help_text='如果设置的不是HTML类型，可为空', verbose_name='正文')),
